  ...
  return (
    <div style={{ marginTop: '20px', fontFamily: 'Arial, sans-serif' }}>
      <form onSubmit={processPayment}>
        <h2 style={{ fontFamily: 'Arial, sans-serif' }}>Checkout</h2>
        ...
        <div>
          <button
            type="submit"
            style={{ backgroundColor: '#34713A', color: 'white' }}
          >
            Place Order
          </button>
        </div>
      ...
      <div>
        <h2 style={{ fontFamily: 'Arial, sans-serif' }}>Order Summary</h2>
        <p>Subtotal: ${totalAmount}</p>
        <p>Taxes: ${(totalWithTaxes - totalAmount).toFixed(2)}</p>
        <p>Total Amount (including taxes): ${totalWithTaxes.toFixed(2)}</p>
      </div>
      <div>
