(function (global, factory) {
  ...
  function useForm(_ref) {
    ...
    var runSyncValidation = React.useCallback(function () {
      var isValid = isFormValid(validators.current, stateRef.current.state);
      stateRef.current.isValid !== isValid && dispatchFormState(_objectSpread2(_objectSpread2({}, stateRef.current), {}, {
        isValid: isValid
      }));
    }, []);
    ...
    */
    ...
    React.useEffect(function () {
      if (context.formStatus === STATUS.ON_RESET) {
        ...
        var onlyShowOnSubmit = isRadioOrCheckBox;
        var isCustomCmp = type === "custom";
        var forceOnBlur = type === "select" && multiple;

        if (valueFieldLastSyncCheck.current !== valueField.current && validationObj.current !== null && (!onlyShowOnSubmit && initialValue !== "" || isCustomCmp && touched && onSyncBlurState || context.formStatus === STATUS.ON_SUBMIT || !onlyShowOnSubmit && (touched && onFirstBlur.current || !touched && forceOnBlur && (onSyncBlurState || firstTimeCheck) || !touched && !forceOnBlur) || onlyShowOnSubmit && onSyncFocusState)) {
    ...
    var onFirstBlur = React.useRef(false);
  ...
  var PersistStateOnUnmount = /*#__PURE__*/React.memo(function PersistStateOnUnmount(_ref) {
    var children = _ref.children;
    var context = useOwnContext();

    var newContext = _objectSpread2(_objectSpread2({}, context), {}, {
  ...
  function useMultipleForm(onChange) {
    ...
    var _useRef = React.useRef(function (formName, state) {
      ...
      onChange === null || onChange === void 0 ? void 0 : onChange(mergeFormStates(stateRef.current));
    }),
  ...
  exports.Input = Input;
  exports.PersistStateOnUnmount = PersistStateOnUnmount;
